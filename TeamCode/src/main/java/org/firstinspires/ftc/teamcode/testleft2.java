...
@Autonomous(name="test: left 2", group="New")
@Disabled
public class testleft2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(DRIVE_SPEED,  75,  -75, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
