...
@Autonomous(name="New: 5 right 2023 Auto", group="New")
@Disabled
public class new5right2023auto_linear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        encoderDrive(TURN_SPEED,   59, -59, 4.0);  // S2: Turn right 12 Inches with 4 Sec timeout
        encoderDrive(DRIVE_SPEED,  95,  95, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftBackTarget = left_front_drive.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newLeftFrontTarget = left_back_drive.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Currently at",  " at %7d :%7d",
                        left_back_drive.getCurrentPosition(), left_front_drive.getCurrentPosition(), right_front_drive.getCurrentPosition(), right_back_drive.getCurrentPosition());
                telemetry.update();
