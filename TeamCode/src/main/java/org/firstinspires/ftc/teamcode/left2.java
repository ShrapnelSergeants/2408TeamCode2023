...
@Autonomous(name="Left 2", group="New")
//@Disabled
...
// Calculate the diagonal distance using the formula
          //  double diagonalInches = Math.sqrt(Math.pow(forwardInches, 2) + Math.pow(sidewaysInches, 2));
            ...
            newLeftTarget = left_back_drive.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH); /*changed the leftInches to diagonalInches*/
            newRightTarget = right_front_drive.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH); /*changed the rightInches to diagonalInches*/
