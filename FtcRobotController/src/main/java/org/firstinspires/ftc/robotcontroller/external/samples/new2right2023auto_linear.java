...
@Autonomous(name="New: 2 right 2023 Auto", group="New")
@Disabled
public class new2right2023auto_linear extends LinearOpMode {
    ...
    public void runOpMode() {
      ...
      //  right_back_drive = hardwareMap.get(DcMotor.class, "right_back_drive");
        ...
        encoderDrive(DRIVE_SPEED,  400,  400, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
        //encoderDrive(DRIVE_SPEED,  -73,  73, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
        //encoderDrive2(DRIVE_SPEED,  100,  100, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
    ...
    public void encoderDrive(double speed,
        ...
        //
        if (opModeIsActive()) {
            double forwardInches = 59;  // Distance to move forward in inches
            double sidewaysInches = 59; // Distance to move sideways in inches

// Calculate the diagonal distance using the formula
            double diagonalInches = Math.sqrt(Math.pow(forwardInches, 2) + Math.pow(sidewaysInches, 2));


            // Determine new target position, and pass to motor controller
            newLeftTarget = left_back_drive.getCurrentPosition() + (int)(diagonalInches * COUNTS_PER_INCH); /*changed the leftInches to diagonalInches*/
            newRightTarget = right_front_drive.getCurrentPosition() + (int)(diagonalInches * COUNTS_PER_INCH); /*changed the rightInches to diagonalInches*/
            ...
            while (opModeIsActive() &&
                    ...
                    (left_back_drive.isBusy() && right_front_drive.isBusy())) {

                //Display it for the driver.
                telemetry.addData("Running to",  " %7d :%7d", newLeftTarget, newRightTarget);
                telemetry.addData("Currently at",  " at %7d :%7d",
                        left_back_drive.getCurrentPosition(), right_front_drive.getCurrentPosition());
                telemetry.update();
