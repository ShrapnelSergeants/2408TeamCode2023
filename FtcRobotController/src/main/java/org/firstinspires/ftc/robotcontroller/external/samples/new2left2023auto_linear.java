...
@Autonomous(name="New: 2 left 2023 Auto", group="New")
@Disabled
public class new2left2023auto_linear extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //encoderDrive(TURN_SPEED,  59,  -59, 5.0);  // S1: Forward 48 Inches with 5 Sec timeout
       // encoderDrive2(DRIVE_SPEED,  95,  95, 4.0);  // S1: Forward 48 Inches with 5 Sec timeout
        //encoderDrive2(TURN_SPEED, 95,95, 4.0);
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            newLeftTarget = left_front_drive.getCurrentPosition() + (int)(leftInches * COUNTS_PER_INCH);
            newRightTarget = right_back_drive.getCurrentPosition() + (int)(rightInches * COUNTS_PER_INCH);
            ...
            while (opModeIsActive() &&
                    ...
                    (left_front_drive.isBusy() && right_back_drive.isBusy())) {

                //Display it for the driver.
                telemetry.addData("Running to",  " %7d :%7d", newLeftTarget,  newRightTarget);
                telemetry.addData("Currently at",  " at %7d :%7d",
                        left_front_drive.getCurrentPosition(), right_back_drive.getCurrentPosition());
                telemetry.update();
