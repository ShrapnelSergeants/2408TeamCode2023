...
@Autonomous(name="New: Global Forward 2023 Auto", group="New")
@Disabled
public class newGlobalForward2023auto_linear extends LinearOpMode {
    ...
    public void encoderDrive(double speed,
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Running to",  " %7d :%7d", newLeftFrontTarget,  newLeftBackTarget, newLeftFrontTarget,  newRightBackTarget);
